"""Name: lambdaCreateImage

   Description: This lambda function runs in a region and queries ec2
                instances based on a tag labeled ScheduledBackup.  If
                the tag has a value of "true" then the script will take 
                an image of that instance.
                
    Role Policy
    The following role policies are required for this function to work:
...
def create_image(ec2, image_type):
    ...
    # This function takes in a dict of ec2's filtered by get_instance_backup
    # loops and creates an image of each with a name of 
    # the instance_id and the timestamp of Hour, Minute, Month, Day, Year
